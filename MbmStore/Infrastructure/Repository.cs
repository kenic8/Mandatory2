...
namespace MbmStore.Infrastructure
{
    public static class Repository
    {
        ...
        static Repository() {
            ...
            // Book no 2
            Book myBook2 = new Book("Georg Martin", "With a Little Help from My Friends: The Making of Sgt. Pepper", 180.00M, 1995,7);
        ...
        track14.Composer = "Lennon, McCartney";
            ...
            Movie movie1 = new Movie("Jungle Book", 160.50M, "junglebook.jpg", "Jon Favreau",1);
            movie1.Category = "Movie";
            Products.Add(movie1);

            Movie movie2 = new Movie("Gladiator", 49.95M, "gladiator.jpg", "Ridley Scott",2);
            movie2.Category = "Movie";
            Products.Add(movie2);

            Movie movie3 = new Movie("Forrest Gump", 154.50M, "forrest-gump.jpg", "Robert Zemeckis",3);
